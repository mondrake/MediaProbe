...
class CameraInfo5DmkIII extends Collection {

  protected static $map = array (
  'name' => 'CanonCameraInfo5DmkIII',
  'title' => 'Canon CameraInfo5DmkIII',
  ...
  array (
    ...
    array (
      ...
      'exiftoolDOMNode' => 'Canon:FileIndex2',
    ),
    664 =>
    array (
    ...
    array (
      ...
      'title' => 'Directory Index 2',
      'format' =>
      array (
        0 => 4,
      ),
      'exiftoolDOMNode' => 'Canon:DirectoryIndex2',
    ),
  ),
);
}
