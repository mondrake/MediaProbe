...
class JpegSegmentSos extends JpegSegmentBase
{
    ...
    protected function doParseData(DataElement $data): void
    {
        ...
        // Some images have some trailing (garbage?) bytes following the EOI
        // marker, which we store in a RawData object.
        ...
        new Undefined($this, [(new DataWindow($data, 0, $scan_size))->getBytes()]);
